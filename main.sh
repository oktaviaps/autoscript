...
Exp1=$(curl https://raw.githubusercontent.com/oktaviaps/permission/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/oktaviaps/permission/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/oktaviaps/permission/main/ip | grep $ipsaya | awk '{print $3}')
